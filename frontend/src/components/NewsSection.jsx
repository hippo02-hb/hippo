      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <Button onClick={loadNews} className="mt-4 bg-orange-500 hover:bg-orange-600">Thử lại</Button>
          </div>
        </div>
      </section>
    );
    ...
    <section className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {!loading && news.length === 0 && (
          <div className="text-center py-12"><p className="text-gray-500">Hiện tại chưa có tin tức mới.</p></div>
        )}
      </div>
    </section>
  );
